...
class Order(models.Model):
    ...
    shipping_address = models.CharField(max_length=100, default='',blank=True, null = True)
    billing_address = models.CharField(max_length=100, default='',blank=True, null = True)
